...
public class frmType extends JInternalFrame {
    ...
    public frmType() {
        ...
        super("Gestion des types d'écriture", 
            true, //resizable
            true, //closable
            true, //maximizable
            true);//iconifiable
    ...
    private void initControls() {
        ...
        final String columnNames[] = { "Id", "Libellé" };
        
        final JTable table = new JTable(rowData, columnNames);
        JScrollPane scrollPane = new JScrollPane(table);
        
        JPanel panBouton = new JPanel (new GridLayout(2,1,10,10));
        btnNouveau.addActionListener(new frmType.MenuActionListener());
        panBouton.add (btnNouveau);
        btnQuitter.addActionListener(new frmType.MenuActionListener());
