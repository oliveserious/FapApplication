...
public class frmEnt extends JInternalFrame {
    ...
    private void initControls() {
        ...
        final String columnNames[] = { "IDENT", "RAISON SOCIALE"};
        
        final JTable table = new JTable(rowData, columnNames);
        JScrollPane scrollPane = new JScrollPane(table);
        
        JPanel panBouton = new JPanel (new GridLayout(2,1,10,10));
        btnNouveau.addActionListener(new frmEnt.MenuActionListener());
        panBouton.add (btnNouveau);
        btnQuitter.addActionListener(new frmEnt.MenuActionListener());
